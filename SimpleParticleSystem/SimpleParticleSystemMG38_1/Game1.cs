...
// </copyright>
namespace SimpleParticleSystemMG38_1
{
    using Microsoft.Xna.Framework;
    using Microsoft.Xna.Framework.Graphics;
    using Microsoft.Xna.Framework.Input;
    using SimpleParticleSystemMG38_1.Graphics;
    using SimpleParticleSystemMG38_1.ParticleSystem;
    ...
    public class Game1 : Game
    {
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            particleSystem.Draw(view, projection, graphics.GraphicsDevice);
