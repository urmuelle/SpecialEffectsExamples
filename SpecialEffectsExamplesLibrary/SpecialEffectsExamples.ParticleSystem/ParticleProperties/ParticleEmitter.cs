...
namespace SpecialEffectsExamplesLibrary.ParticleSystem.ParticleProperties
{
    ...
    public class ParticleEmitter
    {
        ...
        public ParticleEmitter(GraphicsDevice graphicsDevice, ContentManager contentManager, string textureFilename)
        {
        ...
        public ParticleEmitter(ContentReader input)
        {
            ...
            this.Position = input.ReadVector3();
            this.Gravity = input.ReadVector3();
            this.SpawnDir1 = input.ReadVector3();
            this.SpawnDir2 = input.ReadVector3();
            var col = input.ReadVector4();
            this.startColor1 = new Color(col.X, col.Y, col.Z, col.W);
            col = input.ReadVector4();
            this.startColor2 = new Color(col.X, col.Y, col.Z, col.W);
            col = input.ReadVector4();
            this.endColor1 = new Color(col.X, col.Y, col.Z, col.W);
            col = input.ReadVector4();
            this.endColor2 = new Color(col.X, col.Y, col.Z, col.W);
            this.EmitRateMin = input.ReadSingle();
            this.EmitRateMax = input.ReadSingle();
            this.EmissionRadius = input.ReadVector3();
            this.ParticleLifeTimeMin = input.ReadSingle();
            this.ParticleLifeTimeMax = input.ReadSingle();
            this.particleSizeMin = input.ReadSingle();
            this.particleSizeMax = input.ReadSingle();
            var blendState = input.ReadString();
            this.SourceBlendMode = (Blend)Enum.Parse(typeof(Blend), blendState);
            blendState = input.ReadString();
            this.DestBlendMode = (Blend)Enum.Parse(typeof(Blend), blendState);
            this.NumParticles = input.ReadInt32();
            this.textureFilename = input.ReadString();

            LoadContent(graphicsDevice, input.ContentManager);
