...
namespace SpecialEffectsExamplesLibrary.ParticleSystem.AdvancedParticleSystem
{
    ...
    using SpecialEffectsExamplesLibrary.ParticleSystem.AdvancedParticleSystem.Parser;
    ...
    public class ParticleEmitter
    {
        ...
        public ParticleEmitter(ContentReader input)
        {
            ...
            Compile(input.ReadString());

            LoadContent(((IGraphicsDeviceService)input.ContentManager.ServiceProvider.GetService(typeof(IGraphicsDeviceService))).GraphicsDevice, input.ContentManager);
        }
