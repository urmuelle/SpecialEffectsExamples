...
namespace ExplosionClusterMG38_1
{
    ...
    public class ExplosionCluster : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame01"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame02"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame03"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame04"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame05"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame06"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame07"), 0.03f);
            explosionAnimation.AddFrame(Content.Load<Texture2D>("Ch20p2_Explosion_Frame08"), 0.03f);
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            Matrix world = Matrix.CreateTranslation(0, 4, 0);
